package com.sir.go.tool.excel.CareerTest;
...
import com.sir.go.tool.excel.CareerTest.entity.Options;
import com.sir.go.tool.excel.CareerTest.entity.Question;

/**
 * 
 * @Title: ImportMain.java
 * @Package com.sir.go.tool.excel.CareerTest
 * @Description:  职业价值观 导入模板
 * @author 作者：sirzc
 * @date 创建时间：2018年1月10日 下午5:29:42
 * @version V1.0
 */
public class ImportByWorkvalues {
	public static void main(String[] args) throws Exception {
		// 准备excel文件流
		InputStream excelStream = new FileInputStream("C:/Users/Administrator/Desktop/workvaluesImport.xlsx");
